...
6. Crie um novo `Pull Request` _(PR)_
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-016-b-project-lessons-learned/pulls) e confira que o seu _Pull Request_ está criado
